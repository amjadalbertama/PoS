                ...
                <div class="card"><br>
                    <div class="card-body col-lg-12 mx-auto">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5><b style="color: #717ff5;">Add Distribution Out</b></h5>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="mb-3">
                            <label for="branch_origin" class="form-label">Destination Branch :</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="code" name="code" data-bs-toggle="modal" data-bs-target="#selectCodeItemDistOut" required>
                        </div>
                        <div class="mb-3">
...
<!-- Modals Code Item -->
<div class="modal fade" id="selectCodeItemDistOut" tabindex="-1" aria-labelledby="inputModalLabel" aria-hidden="true">
