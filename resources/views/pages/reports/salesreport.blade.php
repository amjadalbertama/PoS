            ...
            <div class="col-lg-12">
                <div class="row"><!-- Change to row class -->
                            ...
                            <div class="card-body"><br>
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        <label for="invoiceInput" class="form-label">Id Transaction:</label>
                                        <input type="text" class="form-control" id="invoiceInput" placeholder="Enter id ">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="invoiceInput" class="form-label">Sales Type:</label>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title" style="color: #717ff5;">Data Sales</h5>
