                ...
                <div class="card">
                        <div class="card-body"><br>
                            ...
                            <div class="row align-items-center justify-content-between mb-3">
                                ...
                                <a class="btn btn-primary tambah-btn" href="{{ url('/add/stockin') }}">Cetak Laporan</a>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-center mt-3">
                                <nav aria-label="Page navigation">
                                    <ul class="pagination">
                                        ...
                                        @for ($i = 1; $i <= ceil(count($dataStockIn) / $perPage); $i++)
                                        <li class="page-item {{ $i === $currentPage ? 'active' : '' }}">
                                            <a class="page-link" href="{{ $request->url() }}?page={{ $i }}">{{ $i }}</a>
                                        </li>
                                        @endfor

                                        @if ($currentPage < ceil(count($dataStockIn) / $perPage))
                                        <li class="page-item">
